...
public class buymiceKeywords {
	...
	public static void clickMo() throws InterruptedException {
		// TS_017 click speaker icon
		driver.findElement(By.id(userData.mice_img)).click();
		Thread.sleep(6000);
	
		
	}

	public static void clickKen() throws InterruptedException {
		// TS_018 click Bose Icon
		driver.findElement(By.id(userData.ken_id)).click();
		Thread.sleep(6000);
	...
	{
		driver.close();
		logCollector.debug("buy mouse successfull");
