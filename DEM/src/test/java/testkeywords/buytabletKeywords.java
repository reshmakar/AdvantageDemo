...
public class buytabletKeywords {
	...
	public static void clickTab() throws InterruptedException {
		// TS_017 click speaker icon
		driver.findElement(By.id(userData.tablet_img)).click();
		
		Thread.sleep(6000);
		
	}

	public static void clickHP() throws InterruptedException {
		// TS_018 click HP Icon
		driver.findElement(By.id(userData.hp_id)).click();
	
		Thread.sleep(6000);
	}
	public static void clickBose() throws InterruptedException {
		// TS_018 click Bose Icon
		driver.findElement(By.xpath(userData.bose_img)).click();
		Thread.sleep(6000);
	...
	public static void checkout() throws InterruptedException {
		...
		//driver.findElement(By.id(userData.checkoutid)).click();
	...
	{
		driver.close();
		logCollector.debug("buy tablet successful");
