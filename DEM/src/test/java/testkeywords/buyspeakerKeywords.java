...
public class buyspeakerKeywords {
	...
	public static void clickSp() throws InterruptedException {
		// TS_017 click speaker icon
		driver.findElement(By.id(userData.speaker_img)).click();
		Thread.sleep(6000);
	...
	{
		driver.close();
		logCollector.debug("buy speaker sucessfull");
